...
async def 도움말(ctx, 플러그인:Option(str,"다음 중 하나를 선택하세요.", choices=["서버관리", "검색", "놀이", "마인크래프트", "봇"])=None):
    ...
    if 플러그인 == None:
        ...
        return await ctx.respond(embed=help)
    else:
        if 플러그인 == "서버관리":
            ...
            return await ctx.respond(embed=serverhelp)
        ...
        if 플러그인 == "검색":
            ...
            return await ctx.respond(embed=searchhelp)
        ...
        if 플러그인 == "놀이":
            ...
            return await ctx.respond(embed=playhelp)
        ...
        if 플러그인 == "마인크래프트":
            ...
            return await ctx.respond(embed=minecrafthelp)
        ...
        if 플러그인 == "봇":
            ...
            return await ctx.respond(embed=bothelp)
